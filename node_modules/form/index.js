...
Form.prototype.label = function(lname, attrs) {
  this.getContent = this.getContent + '<label '+jsonToStringAttrs(attrs)+'>'+lname+'</label>';
};




Form.prototype.text = function(name, value, attrs, validations) {
  ...
  if(typeof validations === 'object' && Object.getOwnPropertyNames(this.postData).length !== 0){
  ...
  this.getContent = this.getContent + '<input '+jsonToStringAttrs(attrs)+'>';
  
};


Form.prototype.password = function(name, attrs, validations, value) {
  
  this.getContent = this.getContent + '<input type="password" name="'+name+'"  value="'+ value+'" '+jsonToStringAttrs(attrs)+'>';
